...
$persons = [
    [
        ...
        "name" => "Oliver Kopyov",
        "image" => "avatar-b.png",
        "job_title" > "IT Director, Gotbootstrap Inc.",
        "tel" => "+13174562564",
    ...
    [
        ...
        "name" => "Sesha Gray",
        "image" => "avatar-c.png",
        "job_title" > "Project Manager, Gotbootstrap Inc.",
        "tel" => "+13174562564",
    ...
    [
        ...
        "image" => "avatar-e.png",
        "job_title" > "Human Resources, Gotbootstrap Inc.",
        "tel" => "+13174562564",
    ...
    <body class="mod-bg-1 mod-nav-link ">
        <main id="js-page-content" role="main" class="page-content">
            ...
            <div class="row js-list-filter" id="js-contacts">
                ...
                <div class="col-xl-4">
                    <div id="<?php echo $person['id']?>" class="card border shadow-0 mb-g shadow-sm-hover" data-filter-tags="<?php echo $person['tag']?>">
                        <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                            <div class="d-flex flex-row align-items-center">
                                ...
                                <div class="info-card-text flex-1">
                                    ...
                                    <span class="text-truncate text-truncate-xl"><?php echo $person['job_title']?></span>
                                </div>
                        ...
                        <div class="card-body p-0 collapse show">
                            <div class="p-3">
                                <a href="tel:<?php echo $person['tel']?>" class="mt-1 d-block fs-sm fw-400 text-dark">
